...
func (self *message) To() *web3.Address {
	return self.to
}
...
func NewStateTransition(evm *evm.EVM, msg Message, feeReceiver web3.Address) *StateTransition {
...
func (st *StateTransition) to() web3.Address {
