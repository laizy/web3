...
func init() {
	...
	if len(binRuntimeERC20Str) != 0 {
		binRuntimeERC20, err = hex.DecodeString(binRuntimeERC20Str[2:])
		if err != nil {
			panic(fmt.Errorf("cannot parse ERC20 bin runtime: %v", err))
		}
	}
}
